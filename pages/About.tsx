    ...
    <div className="pt-24 sm:pt-32 pb-16 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
            ...
            >
              ...
              <div className="relative rounded-[2.5rem] lg:rounded-[3.5rem] overflow-hidden shadow-2xl border border-white/5 aspect-[4/5] lg:h-[700px]">
                ...
                <div className="absolute bottom-6 left-6 right-6 lg:bottom-10 lg:left-10 lg:right-10 glass-card p-6 lg:p-10 rounded-[2rem] border-white/10">
                  <p className="text-xs font-black tracking-widest text-white/40 mb-2 uppercase">{t('about_overlay_badge')}</p>
                  <h5 className="text-2xl lg:text-3xl font-black italic tracking-tighter uppercase text-[#ffce00]">{t('about_overlay_title')}</h5>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative">
                <span className="text-[#ffce00] font-black tracking-[0.5em] text-[10px] uppercase mb-8 block">{t('about_badge')}</span>
                <h1 className="hero-heading font-black italic tracking-tighter leading-[0.8] mb-8 uppercase text-white">
                  {t('about_title_1')} <br /> <span className="gold-gradient-text">{t('about_title_2')}</span>
                </h1>
              ...
              <div className="grid grid-cols-2 gap-8 lg:gap-12">
                {[
                  { label: t('about_stat_surface'), val: t('about_stat_surface_val') },
                  { label: t('about_stat_equip'), val: t('about_stat_equip_val') },
                  { label: t('about_stat_uptime'), val: t('about_stat_uptime_val') },
                  { label: t('about_stat_programs'), val: t('about_stat_programs_val') },
                ].map((item, i) => (
      ...
      <section className="bg-black py-32 relative">
        <div className="app-container">
          <div className="text-center mb-24">
            <h3 className="text-[#ffce00] font-black tracking-[0.5em] text-[10px] uppercase mb-8">{t('about_comp_badge')}</h3>
            <h2 className="section-heading font-black italic tracking-tighter uppercase text-white mb-10">{t('about_comp_title_1')} <span className="gold-gradient-text">{t('about_comp_title_2')}</span></h2>
            ...
            >
              ...
              <h4 className="text-2xl font-black text-white italic tracking-tighter">{REPUTATION_STATS.rating}.0 {t('about_comp_rating')}</h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
            ...
            >
              <h4 className="text-xl font-black italic tracking-tighter text-gray-500 mb-12 uppercase">{t('about_comp_typical')}</h4>
            ...
            >
              ...
              <h4 className="text-2xl font-black italic tracking-tighter text-[#ffce00] mb-12 uppercase">{t('about_comp_gymland')}</h4>
              <div className="space-y-10">
      ...
      <section className="bg-white/[0.02] border-y border-white/5 relative overflow-hidden">
        ...
        <div className="app-container relative z-10 text-center">
          <h2 className="section-heading font-black italic tracking-tighter mb-16 sm:mb-24 uppercase text-white">{t('about_values_title_1')} <span className="text-[#ffce00]">{t('about_values_title_2')}</span></h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24">
            {[
              { title: t('about_val_longevity'), icon: 'fa-heart-pulse', desc: t('about_val_longevity_desc') },
              { title: t('about_val_strength'), icon: 'fa-fire-alt', desc: t('about_val_strength_desc') },
              { title: t('about_val_community'), icon: 'fa-network-wired', desc: t('about_val_community_desc') },
            ].map((p, idx) => (
