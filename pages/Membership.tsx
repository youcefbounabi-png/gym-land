...
const Membership: React.FC = () => {
  return (
    <div className="pt-32 pb-16 relative overflow-hidden bg-[#020202]">
      {/* Structural Refinement: Constant container alignment */}
      <section className="p-0 mt-16 sm:mt-24">
        <div className="app-container relative z-10">
          <div className="text-center max-w-4xl mx-auto mb-16 sm:mb-32">
            ...
            >
              CHOOSE YOUR <br /> <span className="gold-gradient-text">INTENSITY.</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              Transparent tier-based protocols designed for maximum biological advancement. No contracts, just pure performance commitment.
            </motion.p>
          </div>
            ...
            {PLANS.map((plan, idx) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <h3 className="text-xs font-black tracking-[0.4em] uppercase text-gray-500 mb-2">{plan.name}</h3>
                  ...
                  <ul className="space-y-5 mb-12 flex-grow">
                    {plan.features.map(feature => (
                      <li key={feature} className="flex items-center gap-4 group/item">
                        ...
                        <span className="text-sm font-light text-gray-400 group-hover/item:text-white transition-colors">{feature}</span>
                      </li>
                    ))}
                  </ul>
                ...
                {/* Ambient Decorative Glow on Hover */}
          ...
          {/* Corporate Section - Fixed dead links */}
          <div className="mt-24 sm:mt-32 p-10 sm:p-14 bg-white/5 border border-white/10 rounded-[3rem] backdrop-blur-2xl flex flex-col lg:flex-row items-center justify-between gap-10 hover:border-[#ffce00]/20 transition-all group">
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8 sm:gap-10 text-center sm:text-left">
              ...
              <div>
                <h4 className="text-2xl sm:text-3xl font-black italic tracking-tighter uppercase mb-2 text-white">CORPORATE NODES</h4>
                <p className="text-gray-500 text-sm font-light max-w-sm leading-relaxed">Synchronize your team's biological performance with specialized high-performance enterprise protocols.</p>
              </div>
            </div>
