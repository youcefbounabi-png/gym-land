      ...
      <section className="p-0 mt-16 sm:mt-24">
        <div className="app-container">
          <div className="max-w-4xl mb-20 sm:mb-32 px-4">
            <h1 className="hero-heading font-black italic tracking-tighter mb-10 leading-none uppercase text-white">THE <span className="text-[#ffce00]">PROOF</span> <br /> OF WORK.</h1>
            <p className="text-gray-400 text-lg md:text-xl lg:text-2xl font-light leading-relaxed">Real people. Real effort. Witness the metamorphosis of those who committed to the Gymland philosophy.</p>
          </div>

          <div className="space-y-32 sm:space-y-48">
            {TRANSFORMATIONS.map((t, idx) => (
              <div key={t.id} className={`flex flex-col ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-16 lg:gap-24`}>
                <div className="w-full lg:w-2/3 grid grid-cols-2 gap-4 sm:gap-6 relative group">
                  ...
                  <div
                    ...
                    onClick={() => setSelectedImage(t.beforeImg)}
                  >
                    <img
                      src={t.beforeImg}
                      ...
                      alt="Before"
                    />
                    <div className="absolute top-4 left-4 sm:top-6 sm:left-6 bg-black/80 px-4 py-1 sm:px-5 sm:py-2 rounded-full text-[10px] font-black tracking-widest uppercase text-white backdrop-blur-md border border-white/10 z-10">BEFORE</div>
                  ...
                  <div
                    ...
                    onClick={() => setSelectedImage(t.afterImg)}
                  >
                    <img
                      src={t.afterImg}
                      ...
                      alt="After"
                    />
                    <div className="absolute top-4 left-4 sm:top-6 sm:left-6 bg-[#ffce00] px-4 py-1 sm:px-5 sm:py-2 rounded-full text-[10px] font-black tracking-widest uppercase text-black shadow-[0_0_15px_rgba(255,206,0,0.4)] z-10">AFTER</div>
                  ...
                  {/* Aesthetic Slider Accent (Center Divider Simulation) */}
                ...
                <div className="w-full lg:w-1/3 space-y-6 sm:space-y-8">
                  ...
                  <h3 className="text-4xl sm:text-5xl font-black italic tracking-tighter uppercase text-white">{t.name}</h3>
                  <div className="inline-block bg-[#ffce00]/10 border border-[#ffce00]/20 px-5 py-2 rounded-xl text-[10px] font-black tracking-widest text-[#ffce00] uppercase mb-4 shadow-[0_0_20px_rgba(255,206,0,0.05)]">
                    {t.timeframe} Evolution
                  </div>
                  <p className="text-gray-400 text-lg sm:text-xl italic font-light leading-relaxed">"{t.result}"</p>
          ...
          <div className="mt-40 text-center bg-[#d4a800] rounded-[3rem] sm:rounded-[4rem] py-20 sm:py-32 px-6 sm:px-10 text-black relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <h2 className="section-heading font-black italic tracking-tighter leading-none mb-10 uppercase">YOUR TURN IS <br /> NEXT.</h2>
              <p className="text-xl sm:text-2xl font-bold opacity-80 mb-12 sm:mb-16 max-w-2xl mx-auto leading-relaxed">Start your 12-week high-performance transformation protocol today.</p>
